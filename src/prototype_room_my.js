...
Room.prototype.handleObserver = function() {
  ...
  let observers = this.find(FIND_MY_STRUCTURES, {structureType: 'observer'});
...
Room.prototype.executeRoom = function() {
  ...
  var constructionSites = this.findWithoutStructType(FIND_MY_CONSTRUCTION_SITES,
  ...
  let constructionSitesBlocker = this.findOnlyStructType(FIND_MY_CONSTRUCTION_SITES,
